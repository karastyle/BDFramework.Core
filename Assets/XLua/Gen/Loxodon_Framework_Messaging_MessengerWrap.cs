...
namespace XLua.CSObjectWrap
{
    ...
    public class LoxodonFrameworkMessagingMessengerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Loxodon.Framework.Messaging.Messenger);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Default", Loxodon.Framework.Messaging.Messenger.Default);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Loxodon.Framework.Messaging.Messenger();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Messaging.Messenger constructor!");
        ...
        static int _m_Subscribe(RealStatePtr L)
        {
		    try {
                ...
                Loxodon.Framework.Messaging.Messenger gen_to_be_invoked = (Loxodon.Framework.Messaging.Messenger)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Messaging.Messenger.Subscribe!");
        ...
        static int _m_Publish(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Messaging.Messenger.Publish!");
