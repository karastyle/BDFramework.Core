...
namespace XLua.CSObjectWrap
{
    ...
    public class LoxodonFrameworkBindingBuilderLuaBindingBuilderWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Loxodon.Framework.Binding.Builder.LuaBindingBuilder);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<Loxodon.Framework.Binding.Contexts.IBindingContext>(L, 2) && translator.Assignable<object>(L, 3))
				{
					...
					var gen_ret = new Loxodon.Framework.Binding.Builder.LuaBindingBuilder(_context, _target);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Binding.Builder.LuaBindingBuilder constructor!");
        ...
        static int _m_For(RealStatePtr L)
        {
		    try {
                ...
                Loxodon.Framework.Binding.Builder.LuaBindingBuilder gen_to_be_invoked = (Loxodon.Framework.Binding.Builder.LuaBindingBuilder)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Binding.Builder.LuaBindingBuilder.For!");
        ...
        static int _m_WithConversion(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<Loxodon.Framework.Binding.Converters.IConverter>(L, 2)) 
                {
                    Loxodon.Framework.Binding.Converters.IConverter _converter = (Loxodon.Framework.Binding.Converters.IConverter)translator.GetObject(L, 2, typeof(Loxodon.Framework.Binding.Converters.IConverter));
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Binding.Builder.LuaBindingBuilder.WithConversion!");
