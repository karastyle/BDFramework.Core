...
{
    public class LoxodonFrameworkAsynchronousIAwaiterBridge : LuaBase, Loxodon.Framework.Asynchronous.IAwaiter
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new LoxodonFrameworkAsynchronousIAwaiterBridge(reference, luaenv);
		}
		
		public LoxodonFrameworkAsynchronousIAwaiterBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
		
        
		void Loxodon.Framework.Asynchronous.IAwaiter.GetResult()
		{
        ...
        bool Loxodon.Framework.Asynchronous.IAwaiter.IsCompleted 
        {
