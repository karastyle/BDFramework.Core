...
{
    public class LoxodonFrameworkAsynchronousIAwaiter_1_SystemObject_Bridge : LuaBase, Loxodon.Framework.Asynchronous.IAwaiter<object>
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new LoxodonFrameworkAsynchronousIAwaiter_1_SystemObject_Bridge(reference, luaenv);
		}
		
		public LoxodonFrameworkAsynchronousIAwaiter_1_SystemObject_Bridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
		
        
		object Loxodon.Framework.Asynchronous.IAwaiter<object>.GetResult()
		{
        ...
        bool Loxodon.Framework.Asynchronous.IAwaiter<object>.IsCompleted 
        {
