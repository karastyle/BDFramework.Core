...
namespace XLua.CSObjectWrap
{
    ...
    public class LoxodonFrameworkViewsWindowManagerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Loxodon.Framework.Views.WindowManager);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Loxodon.Framework.Views.WindowManager();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Views.WindowManager constructor!");
        ...
        static int _m_GetVisibleWindow(RealStatePtr L)
        {
		    try {
                ...
                Loxodon.Framework.Views.WindowManager gen_to_be_invoked = (Loxodon.Framework.Views.WindowManager)translator.FastGetCSObj(L, 1);
        ...
        static int _m_Find(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Views.WindowManager.Find!");
