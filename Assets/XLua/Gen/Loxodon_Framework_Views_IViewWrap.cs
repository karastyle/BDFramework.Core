...
namespace XLua.CSObjectWrap
{
    ...
    public class LoxodonFrameworkViewsIViewWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Loxodon.Framework.Views.IView);
        ...
        {
            return LuaAPI.luaL_error(L, "Loxodon.Framework.Views.IView does not have a constructor!");
        }
        ...
        static int _g_get_Name(RealStatePtr L)
        {
		    try {
                ...
                Loxodon.Framework.Views.IView gen_to_be_invoked = (Loxodon.Framework.Views.IView)translator.FastGetCSObj(L, 1);
