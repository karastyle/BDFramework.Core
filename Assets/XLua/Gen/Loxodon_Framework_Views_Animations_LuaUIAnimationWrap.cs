...
namespace XLua.CSObjectWrap
{
    ...
    public class LoxodonFrameworkViewsAnimationsLuaUIAnimationWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Loxodon.Framework.Views.Animations.LuaUIAnimation);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Loxodon.Framework.Views.Animations.LuaUIAnimation();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Views.Animations.LuaUIAnimation constructor!");
        ...
        static int _m_GetMetatable(RealStatePtr L)
        {
		    try {
                ...
                Loxodon.Framework.Views.Animations.LuaUIAnimation gen_to_be_invoked = (Loxodon.Framework.Views.Animations.LuaUIAnimation)translator.FastGetCSObj(L, 1);
        ...
        static int _s_set_script(RealStatePtr L)
        {
		    try {
                ...
                Loxodon.Framework.Views.Animations.LuaUIAnimation gen_to_be_invoked = (Loxodon.Framework.Views.Animations.LuaUIAnimation)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.script = (Loxodon.Framework.Views.ScriptReference)translator.GetObject(L, 2, typeof(Loxodon.Framework.Views.ScriptReference));
