...
namespace XLua.CSObjectWrap
{
    ...
    public class LoxodonFrameworkViewsLuaUIViewWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Loxodon.Framework.Views.LuaUIView);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Loxodon.Framework.Views.LuaUIView();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Views.LuaUIView constructor!");
        ...
        static int _m_GetMetatable(RealStatePtr L)
        {
		    try {
                ...
                Loxodon.Framework.Views.LuaUIView gen_to_be_invoked = (Loxodon.Framework.Views.LuaUIView)translator.FastGetCSObj(L, 1);
