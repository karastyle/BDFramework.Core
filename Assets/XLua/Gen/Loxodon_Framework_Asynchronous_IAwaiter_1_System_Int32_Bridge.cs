...
{
    public class LoxodonFrameworkAsynchronousIAwaiter_1_SystemInt32_Bridge : LuaBase, Loxodon.Framework.Asynchronous.IAwaiter<int>
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new LoxodonFrameworkAsynchronousIAwaiter_1_SystemInt32_Bridge(reference, luaenv);
		}
		
		public LoxodonFrameworkAsynchronousIAwaiter_1_SystemInt32_Bridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
		
        
		int Loxodon.Framework.Asynchronous.IAwaiter<int>.GetResult()
		{
        ...
        bool Loxodon.Framework.Asynchronous.IAwaiter<int>.IsCompleted 
        {
