...
namespace XLua.CSObjectWrap
{
    ...
    public class LoxodonFrameworkLocalizationsILocalizationWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Loxodon.Framework.Localizations.ILocalization);
        ...
        {
            return LuaAPI.luaL_error(L, "Loxodon.Framework.Localizations.ILocalization does not have a constructor!");
        }
        ...
        static int _m_Subset(RealStatePtr L)
        {
		    try {
                ...
                Loxodon.Framework.Localizations.ILocalization gen_to_be_invoked = (Loxodon.Framework.Localizations.ILocalization)translator.FastGetCSObj(L, 1);
        ...
        static int _m_GetText(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Localizations.ILocalization.GetText!");
        ...
        static int _m_GetBoolean(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Localizations.ILocalization.GetBoolean!");
        ...
        static int _m_GetInt(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Localizations.ILocalization.GetInt!");
        ...
        static int _m_GetLong(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Localizations.ILocalization.GetLong!");
        ...
        static int _m_GetDouble(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Localizations.ILocalization.GetDouble!");
        ...
        static int _m_GetFloat(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Localizations.ILocalization.GetFloat!");
        ...
        static int _m_GetColor(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Localizations.ILocalization.GetColor!");
        ...
        static int _m_GetVector3(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Localizations.ILocalization.GetVector3!");
        ...
        static int _m_GetDateTime(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Localizations.ILocalization.GetDateTime!");
