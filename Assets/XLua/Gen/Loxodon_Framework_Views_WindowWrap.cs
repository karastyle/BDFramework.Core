...
namespace XLua.CSObjectWrap
{
    ...
    public class LoxodonFrameworkViewsWindowWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Loxodon.Framework.Views.Window);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Messenger", Loxodon.Framework.Views.Window.Messenger);
        ...
        {
            return LuaAPI.luaL_error(L, "Loxodon.Framework.Views.Window does not have a constructor!");
        }
        ...
        static int _m_Activate(RealStatePtr L)
        {
		    try {
                ...
                Loxodon.Framework.Views.Window gen_to_be_invoked = (Loxodon.Framework.Views.Window)translator.FastGetCSObj(L, 1);
        ...
        static int _m_Create(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<Loxodon.Framework.Views.IBundle>(L, 2)) 
                {
                    Loxodon.Framework.Views.IBundle _bundle = (Loxodon.Framework.Views.IBundle)translator.GetObject(L, 2, typeof(Loxodon.Framework.Views.IBundle));
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Views.Window.Create!");
        ...
        static int _m_Show(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Views.Window.Show!");
        ...
        static int _m_DoShow(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Views.Window.DoShow!");
        ...
        static int _m_Hide(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Views.Window.Hide!");
        ...
        static int _m_DoHide(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Views.Window.DoHide!");
        ...
        static int _m_Dismiss(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Views.Window.Dismiss!");
        ...
        static int _s_set_WindowManager(RealStatePtr L)
        {
		    try {
                ...
                Loxodon.Framework.Views.Window gen_to_be_invoked = (Loxodon.Framework.Views.Window)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.WindowManager = (Loxodon.Framework.Views.IWindowManager)translator.GetObject(L, 2, typeof(Loxodon.Framework.Views.IWindowManager));
        ...
        static int _s_set_WindowType(RealStatePtr L)
        {
		    try {
                ...
                Loxodon.Framework.Views.Window gen_to_be_invoked = (Loxodon.Framework.Views.Window)translator.FastGetCSObj(L, 1);
                Loxodon.Framework.Views.WindowType gen_value;translator.Get(L, 2, out gen_value);
        ...
        static int _e_ActivatedChanged(RealStatePtr L)
        {
			...
			LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Views.Window.ActivatedChanged!");
            return 0;
        }
        ...
        static int _e_VisibilityChanged(RealStatePtr L)
        {
			...
			LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Views.Window.VisibilityChanged!");
            return 0;
        }
        ...
        static int _e_OnDismissed(RealStatePtr L)
        {
			...
			LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Views.Window.OnDismissed!");
            return 0;
        }
        ...
        static int _e_StateChanged(RealStatePtr L)
        {
		    try {
			    ...
			    int gen_param_count = LuaAPI.lua_gettop(L);
			Loxodon.Framework.Views.Window gen_to_be_invoked = (Loxodon.Framework.Views.Window)translator.FastGetCSObj(L, 1);
                System.EventHandler<Loxodon.Framework.Views.WindowStateEventArgs> gen_delegate = translator.GetDelegate<System.EventHandler<Loxodon.Framework.Views.WindowStateEventArgs>>(L, 3);
                if (gen_delegate == null) {
                    return LuaAPI.luaL_error(L, "#3 need System.EventHandler<Loxodon.Framework.Views.WindowStateEventArgs>!");
                }
			...
			LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Views.Window.StateChanged!");
            return 0;
        }
