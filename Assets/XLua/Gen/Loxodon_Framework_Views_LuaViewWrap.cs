...
namespace XLua.CSObjectWrap
{
    ...
    public class LoxodonFrameworkViewsLuaViewWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Loxodon.Framework.Views.LuaView);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Loxodon.Framework.Views.LuaView();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Views.LuaView constructor!");
        ...
        static int _m_GetMetatable(RealStatePtr L)
        {
		    try {
                ...
                Loxodon.Framework.Views.LuaView gen_to_be_invoked = (Loxodon.Framework.Views.LuaView)translator.FastGetCSObj(L, 1);
