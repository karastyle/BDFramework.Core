...
namespace XLua.CSObjectWrap
{
    ...
    public class LoxodonFrameworkAsynchronousAsyncResultWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Loxodon.Framework.Asynchronous.AsyncResult);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Loxodon.Framework.Asynchronous.AsyncResult();
				...
				if(LuaAPI.lua_gettop(L) == 2 && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2))
				{
					...
					var gen_ret = new Loxodon.Framework.Asynchronous.AsyncResult(_cancelable);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Asynchronous.AsyncResult constructor!");
        ...
        static int _m_SetException(RealStatePtr L)
        {
		    try {
                ...
                Loxodon.Framework.Asynchronous.AsyncResult gen_to_be_invoked = (Loxodon.Framework.Asynchronous.AsyncResult)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Asynchronous.AsyncResult.SetException!");
        ...
        static int _m_SetResult(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Asynchronous.AsyncResult.SetResult!");
