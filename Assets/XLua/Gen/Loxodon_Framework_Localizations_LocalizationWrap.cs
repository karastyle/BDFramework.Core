...
namespace XLua.CSObjectWrap
{
    ...
    public class LoxodonFrameworkLocalizationsLocalizationWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Loxodon.Framework.Localizations.Localization);
        ...
        {
            return LuaAPI.luaL_error(L, "Loxodon.Framework.Localizations.Localization does not have a constructor!");
        }
        ...
        static int _m_AddDataProvider(RealStatePtr L)
        {
		    try {
                ...
                Loxodon.Framework.Localizations.Localization gen_to_be_invoked = (Loxodon.Framework.Localizations.Localization)translator.FastGetCSObj(L, 1);
            
            
                
                {
                    Loxodon.Framework.Localizations.IDataProvider _provider = (Loxodon.Framework.Localizations.IDataProvider)translator.GetObject(L, 2, typeof(Loxodon.Framework.Localizations.IDataProvider));
        ...
        static int _m_GetText(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Localizations.Localization.GetText!");
        ...
        static int _m_GetBoolean(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Localizations.Localization.GetBoolean!");
        ...
        static int _m_GetInt(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Localizations.Localization.GetInt!");
        ...
        static int _m_GetLong(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Localizations.Localization.GetLong!");
        ...
        static int _m_GetDouble(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Localizations.Localization.GetDouble!");
        ...
        static int _m_GetFloat(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Localizations.Localization.GetFloat!");
        ...
        static int _m_GetColor(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Localizations.Localization.GetColor!");
        ...
        static int _m_GetVector3(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Localizations.Localization.GetVector3!");
        ...
        static int _m_GetDateTime(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Localizations.Localization.GetDateTime!");
        ...
        static int _m_GetValue(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Localizations.Localization.GetValue!");
        ...
        static int _g_get_Current(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, Loxodon.Framework.Localizations.Localization.Current);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _s_set_Current(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    Loxodon.Framework.Localizations.Localization.Current = (Loxodon.Framework.Localizations.Localization)translator.GetObject(L, 1, typeof(Loxodon.Framework.Localizations.Localization));
        ...
        static int _e_CultureInfoChanged(RealStatePtr L)
        {
			...
			LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Localizations.Localization.CultureInfoChanged!");
            return 0;
        }
