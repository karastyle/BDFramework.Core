...
namespace XLua.CSObjectWrap
{
    ...
    public class LoxodonFrameworkViewsIWindowWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Loxodon.Framework.Views.IWindow);
        ...
        {
            return LuaAPI.luaL_error(L, "Loxodon.Framework.Views.IWindow does not have a constructor!");
        }
        ...
        static int _m_Create(RealStatePtr L)
        {
		    try {
                ...
                Loxodon.Framework.Views.IWindow gen_to_be_invoked = (Loxodon.Framework.Views.IWindow)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Views.IWindow.Create!");
        ...
        static int _m_Show(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Views.IWindow.Show!");
        ...
        static int _m_Hide(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Views.IWindow.Hide!");
        ...
        static int _m_Dismiss(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Views.IWindow.Dismiss!");
        ...
        static int _e_VisibilityChanged(RealStatePtr L)
        {
			...
			LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Views.IWindow.VisibilityChanged!");
            return 0;
        }
        ...
        static int _e_ActivatedChanged(RealStatePtr L)
        {
			...
			LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Views.IWindow.ActivatedChanged!");
            return 0;
        }
        ...
        static int _e_OnDismissed(RealStatePtr L)
        {
			...
			LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Views.IWindow.OnDismissed!");
            return 0;
        }
        ...
        static int _e_StateChanged(RealStatePtr L)
        {
			...
			LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Views.IWindow.StateChanged!");
            return 0;
        }
