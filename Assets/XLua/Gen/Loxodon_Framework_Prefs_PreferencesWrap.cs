...
namespace XLua.CSObjectWrap
{
    ...
    public class LoxodonFrameworkPrefsPreferencesWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Loxodon.Framework.Prefs.Preferences);
        ...
        {
            return LuaAPI.luaL_error(L, "Loxodon.Framework.Prefs.Preferences does not have a constructor!");
        }
        ...
        static int _m_GetGlobalPreferences_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = Loxodon.Framework.Prefs.Preferences.GetGlobalPreferences(  );
		    ...
		    try {
                ...
                
                {
                    string _name = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = Loxodon.Framework.Prefs.Preferences.GetPreferences( _name );
                        translator.Push(L, gen_ret);
        ...
        static int _m_Register_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    Loxodon.Framework.Prefs.IFactory _factory = (Loxodon.Framework.Prefs.IFactory)translator.GetObject(L, 1, typeof(Loxodon.Framework.Prefs.IFactory));
                    
                    Loxodon.Framework.Prefs.Preferences.Register( _factory );
        ...
        static int _m_SaveAll_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Loxodon.Framework.Prefs.Preferences.SaveAll(  );
        ...
        static int _m_DeleteAll_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    Loxodon.Framework.Prefs.Preferences.DeleteAll(  );
        ...
        static int _m_GetString(RealStatePtr L)
        {
		    try {
                ...
                Loxodon.Framework.Prefs.Preferences gen_to_be_invoked = (Loxodon.Framework.Prefs.Preferences)translator.FastGetCSObj(L, 1);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Prefs.Preferences.GetString!");
        ...
        static int _m_GetFloat(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Prefs.Preferences.GetFloat!");
        ...
        static int _m_GetDouble(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Prefs.Preferences.GetDouble!");
        ...
        static int _m_GetBool(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Prefs.Preferences.GetBool!");
        ...
        static int _m_GetInt(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Prefs.Preferences.GetInt!");
        ...
        static int _m_GetLong(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Prefs.Preferences.GetLong!");
        ...
        static int _m_GetObject(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Prefs.Preferences.GetObject!");
        ...
        static int _m_GetArray(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Prefs.Preferences.GetArray!");
