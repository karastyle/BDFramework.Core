...
namespace XLua.CSObjectWrap
{
    ...
    public class LoxodonFrameworkViewsWindowContainerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Loxodon.Framework.Views.WindowContainer);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Loxodon.Framework.Views.WindowContainer();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Views.WindowContainer constructor!");
        ...
        static int _m_Create_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _name = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = Loxodon.Framework.Views.WindowContainer.Create( _name );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& translator.Assignable<Loxodon.Framework.Views.IWindowManager>(L, 1)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    Loxodon.Framework.Views.IWindowManager _windowManager = (Loxodon.Framework.Views.IWindowManager)translator.GetObject(L, 1, typeof(Loxodon.Framework.Views.IWindowManager));
                    string _name = LuaAPI.lua_tostring(L, 2);
                    
                        var gen_ret = Loxodon.Framework.Views.WindowContainer.Create( _windowManager, _name );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Views.WindowContainer.Create!");
        ...
        static int _m_Activate(RealStatePtr L)
        {
		    try {
                ...
                Loxodon.Framework.Views.WindowContainer gen_to_be_invoked = (Loxodon.Framework.Views.WindowContainer)translator.FastGetCSObj(L, 1);
        ...
        static int _m_Add(RealStatePtr L)
        {
		    try {
                ...
                {
                    Loxodon.Framework.Views.IWindow _window = (Loxodon.Framework.Views.IWindow)translator.GetObject(L, 2, typeof(Loxodon.Framework.Views.IWindow));
