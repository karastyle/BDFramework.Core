...
namespace XLua.CSObjectWrap
{
    ...
    public class LoxodonFrameworkViewsIWindowManagerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Loxodon.Framework.Views.IWindowManager);
        ...
        {
            return LuaAPI.luaL_error(L, "Loxodon.Framework.Views.IWindowManager does not have a constructor!");
        }
        ...
        static int _m_Visibles(RealStatePtr L)
        {
		    try {
                ...
                Loxodon.Framework.Views.IWindowManager gen_to_be_invoked = (Loxodon.Framework.Views.IWindowManager)translator.FastGetCSObj(L, 1);
