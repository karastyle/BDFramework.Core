...
namespace XLua.CSObjectWrap
{
    ...
    public class LoxodonFrameworkCommandsSimpleCommandWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Loxodon.Framework.Commands.SimpleCommand);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 3 && translator.Assignable<System.Action>(L, 2) && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3))
				{
					...
					var gen_ret = new Loxodon.Framework.Commands.SimpleCommand(_execute, _keepStrongRef);
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<System.Action>(L, 2))
				{
					...
					var gen_ret = new Loxodon.Framework.Commands.SimpleCommand(_execute);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Commands.SimpleCommand constructor!");
        ...
        static int _m_CanExecute(RealStatePtr L)
        {
		    try {
                ...
                Loxodon.Framework.Commands.SimpleCommand gen_to_be_invoked = (Loxodon.Framework.Commands.SimpleCommand)translator.FastGetCSObj(L, 1);
