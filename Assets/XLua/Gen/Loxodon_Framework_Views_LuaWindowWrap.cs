...
namespace XLua.CSObjectWrap
{
    ...
    public class LoxodonFrameworkViewsLuaWindowWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(Loxodon.Framework.Views.LuaWindow);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new Loxodon.Framework.Views.LuaWindow();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to Loxodon.Framework.Views.LuaWindow constructor!");
        ...
        static int _m_GetMetatable(RealStatePtr L)
        {
		    try {
                ...
                Loxodon.Framework.Views.LuaWindow gen_to_be_invoked = (Loxodon.Framework.Views.LuaWindow)translator.FastGetCSObj(L, 1);
